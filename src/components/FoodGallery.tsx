...
export default function FoodGallery() {
  ...
  return (
    <section className="max-w-7xl mx-auto rounded-[40px] bg-[#fcf7f1] border border-[#9BA88B]/15 relative overflow-hidden my-16 shadow-sm" id="gallery-section">
      ...
      <div className="relative z-10 flex items-center justify-center px-6 py-20 sm:py-0 sm:aspect-[1222/460]" id="gallery-above-section">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto" id="gallery-header">
          ...
          <h2 className="text-3xl md:text-5xl font-noto-sans-sc text-white tracking-tight mb-6 drop-shadow-sm" id="gallery-title">
            让食物不仅好吃，还吃出身体的能量
          </h2>
      ...
      <div className="relative z-10 px-6 md:px-12 pt-12 pb-24" id="gallery-below-content">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-0 md:gap-8 p-0" id="lightbox-layout">
                  ...
                  <div className="md:col-span-7 p-6 md:p-10 flex flex-col justify-between" id="lightbox-info-side">
                    <div>
                      ...
                      {/* Energy rating panel */}
                      <div className="flex items-center gap-2.5 p-3 rounded-2xl bg-gray-50 border border-gray-100 mb-6" id="lightbox-rating-panel">
