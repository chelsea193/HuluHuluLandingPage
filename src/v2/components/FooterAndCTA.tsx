...
import { MessageCircle, Compass, Mail, MapPin, MessageSquare, Heart, Shield, Facebook, Instagram } from 'lucide-react';
...
export default function FooterAndCTA() {
  ...
  return (
    <div className="w-full bg-[#FAF8F4]" id="cta-footer-parent">
      ...
      {/* FINAL CTA SECTION */}
      <section className="relative w-full pt-10 pb-24 md:pt-16 md:pb-24 px-6 md:px-12 bg-gradient-to-b from-[#ECE7DE]/60 to-[#FAF8F4] overflow-hidden" id="final-cta-section">
      ...
      {/* FOOTER */}
      <footer className="w-full bg-[#EB288B] border-t border-white/10 pt-20 pb-12" id="hulu-footer">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 border-t border-white/20 mt-16 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[10px] text-[#F7F3EC]/70 font-noto-sans-sc" id="footer-bottom">
          ...
          <div className="flex gap-4" id="legal-terms">
            <a href="#terms" className="hover:underline hover:text-white">能量服务条款 Services</a>
            <a href="#privacy" className="hover:underline hover:text-white">隐私策略与Cookies</a>
          </div>
        </div>
